...
extern struct Battle_Config
{
	...
	int global_short_damage_rate; // By josh
	int global_long_damage_rate; // By Josh
	int global_weapon_damage_rate; //By Josh
	int global_magic_damage_rate; //By Josh
	int global_misc_damage_rate; //By Josh 
...
// eAthena additions
	...
	int aura_top10_bgranked;
	int aura_top10_bgnormal;
